    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("".concat(API_URL, "/api/v1/store/products/").concat(slug, "/related"), { next: { revalidate: 300 } })];
                case 1:
                    res = _b.sent();
                    if (!res.ok)
                        return [2 /*return*/, []];
...
function RelatedProducts(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, getRelated(slug)];
                case 1:
                    products = _c.sent();
                    if (!products.length)
                        return [2 /*return*/, null];
                    return [2 /*return*/, (<div className="mt-10 pt-8 border-t border-gray-100 dark:border-slate-800">
      <h3 className="text-lg font-bold text-gray-900 dark:text-slate-100 mb-4">Benzer Ürünler</h3>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {products.map(function (p) { return (<a key={p.id} href={"/magaza/".concat(p.slug)} className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 p-3 hover:shadow-md transition-shadow">
