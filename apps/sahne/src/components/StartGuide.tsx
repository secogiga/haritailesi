...
const FREE_CATEGORIES: {
  ...
  { title: 'Meslek Sözlüğü',        desc: 'Mesleki kavramların doğrulanmış ortak tanımları.',            href: '/kutuphane/sozluk', icon: <IcoLibrary />, gradient: 'from-violet-500 to-purple-600', pulse: 'Sözlük' },
  ...
  { title: 'Haritailesi TV',         desc: 'Mesleğin hikâyelerini, insanlarını ve geleceğini yansıtıyoruz.',     href: '/haritailesi-tv', icon: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="7" width="20" height="13" rx="2"/><path d="M8 7V5M16 7V5M8 5L12 2l4 3"/><circle cx="17.5" cy="13.5" r="1.5" fill="currentColor" strokeWidth="0"/><circle cx="17.5" cy="17.5" r="1.5" fill="currentColor" strokeWidth="0"/><rect x="4" y="10" width="11" height="7" rx="1"/></svg>, gradient: 'from-red-500 to-rose-600', pulse: '5 program · 150B+ izlenme', external: false },
