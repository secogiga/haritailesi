...
export const ALL_ACTIONS: RehberAction[] = [
  ...
  { id: 'v-forum',       category: 1, icon: '💬', label: 'Topluluk Tartışmalarını İncele',       href: '/kutuphane' },
  ...
  { id: 'v-sosyaliz',    category: 1, icon: '📢', label: 'Öne Çık Sayfasını Keşfet',            href: '/one-cik' },
  { id: 'v-idoller',     category: 1, icon: '⭐', label: 'Mesleğin Yeni İdolleri',             href: '/mentorluk' },
  { id: 'v-yetenekler',  category: 1, icon: '🌟', label: 'Yeteneklere Bak',                    href: '/mentorluk' },
  ...
  { id: 'p-yetenek',   category: 2, icon: '🌟', label: 'Yeteneklere Destek Ver',               href: '/mentorluk' },
  ...
  { id: 'c-forum-cevap', category: 3, icon: '📚', label: 'Mutfak Kütüphanesi',                  href: '/kutuphane', requiredTiers: MEMBER_TIERS },
  ...
  { id: 'd-isbirligi',    category: 4, icon: '🤝', label: 'İşbirliği Yap',                      href: '/one-cik', requiredTiers: ['corporate_member'] },
  { id: 'd-tanitim',      category: 4, icon: '📢', label: 'Tanıtım Yap',                        href: '/one-cik', requiredTiers: MEMBER_TIERS },
  { id: 'd-yetenek',      category: 4, icon: '🌟', label: 'Yeteneğini Paylaş',                 href: '/mentorluk', requiredTiers: MEMBER_TIERS },
  { id: 'd-kariyer',      category: 4, icon: '⭐', label: 'Kariyer Hikayeni Paylaş',           href: '/mentorluk', requiredTiers: MEMBER_TIERS },
